...
setup(
    ...
    install_requires=[
        ...
        'rios @ https://bitbucket.org/ubarsc/rios/downloads/rios-1.4.3.zip#egg=rios-1.4.3',
        'python-fmask @ https://bitbucket.org/ubarsc/python-fmask/downloads/python-fmask-0.5.0.zip#egg=python-fmask-0.5.0',

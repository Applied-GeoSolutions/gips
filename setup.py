...
setup(
    ...
    install_requires=[
        ...
        'rios @ https://github.com/ubarsc/rios/archive/rios-1.4.6.zip#egg=rios-1.4.6',
        'python-fmask @ https://github.com/ubarsc/python-fmask/archive/python-fmask-0.5.2.zip#egg=python-fmask-0.5.2',

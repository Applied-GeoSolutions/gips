...
expectations['prism'] = collections.OrderedDict([
 ...
 # t_process[prism-vrtppt] recording:
 ('vrtppt',
  [('prism/tiles/CONUS/19821201/CONUS_19821201_prism_vrtppt.tif',
    'raster',
    'gdalinfo-stats',
    ['Driver: VRT/Virtual Raster',
     ...
     '  Minimum=0.000, Maximum=156.030, Mean=5.910, StdDev=11.764',
     '  NoData Value=-9999',
     '  Metadata:',
     '    STATISTICS_MAXIMUM=156.02999877',
     '    STATISTICS_MEAN=5.91009789',
     '    STATISTICS_MINIMUM=0',
     '    STATISTICS_STDDEV=11.76382980',
     '    STATISTICS_VALID_PERCENT=55.2']),
   ('prism/tiles/CONUS/19821202/CONUS_19821202_prism_vrtppt.tif',
    'raster',
    'gdalinfo-stats',
    ['Driver: VRT/Virtual Raster',
     'Size is 1405, 621',
     ...
     'Center      ( -95.7500000,  37.0000000) ( 95d45\' 0.00"W, 37d 0\' 0.00"N)',
     'Band 1 Block=128x128 Type=Float32, ColorInterp=Undefined',
     '  Minimum=0.000, Maximum=235.530, Mean=3.745, StdDev=7.444',
     '  NoData Value=-9999',
     '  Metadata:',
     '    STATISTICS_MAXIMUM=235.52999877',
     '    STATISTICS_MEAN=3.74497710',
     '    STATISTICS_MINIMUM=0',
     '    STATISTICS_STDDEV=7.44422403',
     '    STATISTICS_VALID_PERCENT=55.2']),
   ('prism/tiles/CONUS/19821203/CONUS_19821203_prism_vrtppt.tif',
    'raster',
    'gdalinfo-stats',
    ['Driver: VRT/Virtual Raster',
     'Size is 1405, 621',
     ...
     'Center      ( -95.7500000,  37.0000000) ( 95d45\' 0.00"W, 37d 0\' 0.00"N)',
     'Band 1 Block=128x128 Type=Float32, ColorInterp=Undefined',
     '  Minimum=0.000, Maximum=329.230, Mean=7.718, StdDev=22.715',
     '  NoData Value=-9999',
     '  Metadata:',
     '    STATISTICS_MAXIMUM=329.23001098',
     '    STATISTICS_MEAN=7.71847771',
     '    STATISTICS_MINIMUM=0',
     '    STATISTICS_STDDEV=22.71518558',
     '    STATISTICS_VALID_PERCENT=55.2'])]),
 ...
 ('mask',
  [('sar/tiles/N07E099/2015101/N07E099_2015101_AWBD_mask.tif',
    ...
    ['Driver: GTiff/GeoTIFF',
     ...
     'Center      (  99.5002223,   6.4997777) ( 99d30\' 0.80"E,  6d29\'59.20"N)',
     'Band 1 Block=2250x3 Type=Byte, ColorInterp=Gray',
     '  Description = N07E099_W02DC019DR_mas',
 ...
 ('sign',
  [('sar/tiles/N00E099/2009041/N00E099_2009041_AWB1_sign.tif',
    ...
    ['Driver: GTiff/GeoTIFF',
     ...
     '    STATISTICS_VALID_PERCENT=61.44']),
   ...
   ('sar/tiles/N19E100/2010182/N19E100_2010182_AFBD_sign.tif',
    ...
    ['Driver: GTiff/GeoTIFF',
     ...
     '    STATISTICS_VALID_PERCENT=47.2'])]),
])

expectations['ard'] = collections.OrderedDict([
    ('st',
    [('ard/tiles/030005/20200901/030005_20200901_LC8_st.tif',
    'raster',
    'gdalinfo-stats',
    ['Driver: GTiff/GeoTIFF',
     'Size is 5000, 5000',
     ...
     '    GEOGCS["WGS 84",',
     '        DATUM["WGS_1984",',
     '            SPHEROID["WGS 84",6378140,298.25699999,',
     '                AUTHORITY["EPSG","7030"]],',
     '            AUTHORITY["EPSG","6326"]],',
     '        PRIMEM["Greenwich",0],',
     '        UNIT["degree",0.01745329],',
     ...
     '    UNIT["metre",1,',
     '        AUTHORITY["EPSG","9001"]]]',
     'Origin = (1934415.00000000,2564805.00000000)',
     ...
     '  INTERLEAVE=BAND',
     'Corner Coordinates:',
     'Upper Left  ( 1934415.000, 2564805.000) ( 71d35\'17.25"W, 43d49\'35.65"N)',
     'Lower Left  ( 1934415.000, 2414805.000) ( 72d 3\'17.59"W, 42d31\'35.90"N)',
     'Upper Right ( 2084415.000, 2564805.000) ( 69d47\'11.67"W, 43d28\'21.84"N)',
     'Lower Right ( 2084415.000, 2414805.000) ( 70d17\' 4.01"W, 42d10\'48.30"N)',
     'Center      ( 2009415.000, 2489805.000) ( 70d55\'42.63"W, 43d 0\'15.93"N)',
     'Band 1 Block=256x256 Type=Int16, ColorInterp=Gray',
     '  Description = Band 1',
     '  Minimum=1712.000, Maximum=3109.000, Mean=2670.311, StdDev=112.524',
     '  NoData Value=-9999',
     '  Metadata:',
     '    STATISTICS_MAXIMUM=3109',
     '    STATISTICS_MEAN=2670.31109177',
     '    STATISTICS_MINIMUM=1712',
     '    STATISTICS_STDDEV=112.52378029',
     '    STATISTICS_VALID_PERCENT=32.52'])]),   
])